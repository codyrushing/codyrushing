...
var _isotip = require("isotip");

var _isotip2 = _interopRequireDefault(_isotip);
...
var visualizer = {
  init: function init(_ref) {
    ...
    this.root = _d2.default.select(element);
    this.initDOM();
    _isotip2.default.init({
      html: true,
      removalDelay: 0
    });
    this.loadData(url, function (data) {
      _this.dataset = data.filter(function (node, i) {
        return node.paidLeave !== null;
      });
      _this.processData();
      _this.draw(_this.dataset);
    });
    return this;
  },
  initDOM: function initDOM() {
    ...
    var width = _ref2$width === undefined ? 960 : _ref2$width;
    var _ref2$height = _ref2.height;
    var height = _ref2$height === undefined ? 600 : _ref2$height;
    var _ref2$margins = _ref2.margins;
    var margins = _ref2$margins === undefined ? { top: 80, right: 50, bottom: 50, left: 100 } : _ref2$margins;
    ...
    this.mainGroup = this.svg.append("g").attr({
      "class": "main",
  ...
  nestedStructure: function nestedStructure() {
    var _this2 = this;

    var nest = _d2.default.nest();
    ...
    props.forEach(function (prop) {
      nest.key(function (d) {
        return _this2.getNumericSafe(d[prop], null);
      });
    });
    ...
    nest.sortKeys(function (a, b) {
      ...
      return _d2.default.ascending(a, b);
    });

    return nest;
  },
  getNumericSafe: function getNumericSafe(val) {
  ...
  reduceTotalWeeks: function reduceTotalWeeks(arr) {
    var _this3 = this;

    return arr.reduce(function (a, b) {
      return a + _this3.getNumericSafe(b.paidLeave) + _this3.getNumericSafe(b.unpaidLeave);
    }, 0);
  },
  weeksToRadius: function weeksToRadius(weeks) {
    return Math.sqrt(weeks) + 1;
  },
  processSectionsByIndustry: function processSectionsByIndustry(sectionsByIndustry) {
    var _this4 = this;

    sectionsByIndustry.forEach(function (section) {
      section.mean = _d2.default.mean(section.values, _this4.xAccessor);
      section.median = _d2.default.median(section.values, _this4.xAccessor);
    });

    sectionsByIndustry.sort(function (a, b) {
      if (b.key === "N/A") return -1;
      if (a.key === "N/A") return 1;
      return b.median - a.median;
    });
  },
  processSectionsByPaid: function processSectionsByPaid(sectionsByPaid) {
    var _this5 = this;
    ...
    var maxClusters = sectionsByPaid.map(function (section, i) {
      var max,
          maxValue = 0;
      section.subsectionsByUnpaid = _this5.nestedStructure("unpaidLeave").entries(section.values).reverse();
      section.subsectionsByUnpaid.forEach(function (subsection) {
        var subsectionWeeks = _this5.reduceTotalWeeks(subsection.values);
    ...
    var totalMaxClusterRadius = maxClusters.reduce(function (a, b) {
      return a + Math.sqrt(_this5.reduceTotalWeeks(b.values));
    }, 0);

    var totalMaxClusterWeeks = this.reduceTotalWeeks(maxClusters.reduce(function (a, b) {
      return a.concat(b.values);
    }, []));

    sectionsByPaid.forEach(function (section, i) {
      var prev = sectionsByPaid[i - 1] || { x0: 0, x1: 0 };
      // use the number of weeks in our max cluster to determine width of section
      section.width = Math.sqrt(_this5.reduceTotalWeeks(maxClusters[i].values)) / totalMaxClusterRadius * workableWidth;
      ...
      _this5.processSubsectionsByUnpaid(section, section.subsectionsByUnpaid);
    });
  },
  processSubsectionsByUnpaid: function processSubsectionsByUnpaid(section, subsectionsByUnpaid) {
    var _this6 = this;

    var yOffset = 0;
    subsectionsByUnpaid.forEach(function (subsection, i) {
      var radius = _this6.weeksToRadius(_this6.reduceTotalWeeks(subsection.values)),
      ...
      subsection.values.forEach(function (node, i, arr) {
        node.radius = _this6.weeksToRadius(_this6.reduceTotalWeeks([node]));
        node.cluster = clusterData;
      });

      packLayout = _d2.default.layout.pack().size(packingBoxDimensions).padding(10).value(function (d) {
        return d.radius * d.radius;
      }).nodes({
        children: subsection.values
      });

      subsection.values.forEach(function (node, i) {
  ...
  draw: function draw() {
    ...
    this.axisGroup.x.append("line").attr("class", "line").attr("x1", 0).attr("x2", this.width);

    this.axisGroup.x.append("text").attr("transform", "translate(" + this.width / 2 + ", 0)").attr("dy", "-2.5em").attr("class", "heading").text("Paid leave (weeks)");

    var xTickGroups = this.axisGroup.x.selectAll("g.tick").data(this.sections.byPaid).enter().append("g").attr("class", "tick").attr("transform", function (d) {
      return "translate(" + (d.x0 + d.width / 2) + ", 0)";
    });

    xTickGroups.append("text").text(function (d) {
      return d.key;
    }).attr("y", "-0.5em").attr("dy", "0");

    xTickGroups.append("line").attr("y1", 0).attr("y2", 5);

    this.bubbleGroups = this.mainGroup.selectAll("g.bubble-group").data(this.dataset).enter().append("g").attr("transform", function (d) {
      return "translate(" + d.x + "," + d.y + ")";
    }).attr("class", function (d) {
      var classes = [_this7.slugify(d.industry)];
      if (d.subclassification) {
        classes.push(_this7.slugify(d.subclassification));
      }
      return classes.join(" ");
    }).classed("bubble-group", true).on("mouseover", function (d) {
      var _this8 = this;

      setTimeout(function () {
        _isotip2.default.open(_this8, {
          content: d.name
        });
      }, 0);
    }).on("mouseout", function (d) {
      _isotip2.default.close();
    }).each(function (d, i) {
      var group = _d2.default.select(this),
          totalWeeks = self.reduceTotalWeeks([d]),
          paidAngle = d.paidLeave / totalWeeks * (Math.PI * 2),
          arc = _d2.default.svg.arc().innerRadius(0).outerRadius(d.radius).startAngle(0);

      if (d.unpaidLeave) {
        group.append("path").datum({
          startAngle: paidAngle,
          endAngle: Math.PI * 2
        }).attr("class", "unpaid-portion").style("fill", function () {
      ...
      if (d.paidLeave) {
        group.append("path").datum({
          endAngle: paidAngle
        }).attr("class", "paid-portion").style("fill", function () {
          return self.scale.color(d.paidLeave);
        }).attr("d", arc);
      }
    });

    this.bubbles = this.bubbleGroups.append("circle").attr("shape-rendering", "crispEdges").attr("stroke-width", 1).attr("stroke", function (d) {
      return _d2.default.lab(_this7.scale.color(d.paidLeave)).darker();
    }).attr("fill", "none").attr("paid", function (d) {
      return d.paidLeave;
    }).attr("unpaid", function (d) {
      return d.unpaidLeave || "null";
    ...
    this.forceLayout = _d2.default.layout.force().nodes(this.dataset).size([this.width, this.height]).gravity(0).charge(0).friction(0).on("tick", function (e) {
      return _this7.onTick(e);
    }).start();
  },
  processData: function processData() {
    this.sections = {
      byPaid: this.nestedStructure("paidLeave").entries(this.dataset),
      byIndustry: _d2.default.nest().key(function (d) {
        return d.industry;
    ...
    this.scale = {
      ...
      color: _d2.default.scale.linear().domain(_d2.default.extent(this.dataset.map(this.xAccessor))).range(["#00A4FF", "#06D800"]).interpolate(_d2.default.interpolateLab)
    };
  ...
  onTick: function onTick(e) {
    ...
    .each(this.collide.call(this, 0.5)).attr("transform", function (d) {
      return "translate(" + d.x + "," + d.y + ")";
    });
  ...
  moveTowardCluster: function moveTowardCluster(alpha) {
    var damper = 0.202;
    return function (d) {
  ...
  bounceBack: function bounceBack(alpha) {
    var ctx = this;
    return function (d) {
  ...
  cluster: function cluster(alpha) {
    return function (d) {
  ...
  collide: function collide(alpha) {
    var padding = 0,
    ...
    var quadtree = _d2.default.geom.quadtree(this.dataset);
    return function (d) {
  ...
  loadData: function loadData(url, done) {
    if (!url) throw new Error("Data url must be provided");
    _d2.default.csv(url, function (d) {
      return {
        id: +d.id,
        name: d.name,
        industry: d.industry,
...
},{"d3":1,"isotip":2}],4:[function(require,module,exports){
"use strict";
...
window.addEventListener("DOMContentLoaded", function (e) {
  Object.create(_visualizer2.default).init({
    url: "data.csv",
    element: document.querySelectorAll(".container")[0]
  });
});

},{"./components/visualizer":3}]},{},[4])
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
